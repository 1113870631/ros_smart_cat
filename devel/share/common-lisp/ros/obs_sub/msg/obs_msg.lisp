...
(cl:defmethod cl:initialize-instance :after ((m <obs_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'obs_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obs_sub-msg:<obs_msg> is deprecated: use obs_sub-msg:obs_msg instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <obs_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_sub-msg:x1-val is deprecated.  Use obs_sub-msg:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <obs_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_sub-msg:y1-val is deprecated.  Use obs_sub-msg:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <obs_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_sub-msg:x2-val is deprecated.  Use obs_sub-msg:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <obs_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_sub-msg:y2-val is deprecated.  Use obs_sub-msg:y2 instead.")
  (y2 m))

(cl:ensure-generic-function 'dis-val :lambda-list '(m))
(cl:defmethod dis-val ((m <obs_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_sub-msg:dis-val is deprecated.  Use obs_sub-msg:dis instead.")
  (dis m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <obs_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obs_sub-msg:pos-val is deprecated.  Use obs_sub-msg:pos instead.")
  (pos m))
